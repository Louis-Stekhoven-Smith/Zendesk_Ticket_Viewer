def data():
    return {'ticket': {'problem_id': None, 'created_at': '2017-11-18T06:59:11Z', 'fields': [], 'forum_topic_id': None,
                       ...
                       'priority': 'normal', 'url': 'https://xyzinc.zendesk.com/api/v2/tickets/1.json',
                       'id': 1, 'external_id': None, 'is_public': True, 'has_incidents': False,
                       'submitter_id': 115742086594, 'subject': 'Sample ticket: Meet the ticket',
                       'requester_id': 115743618954, 'brand_id': 114095027974, 'type': 'incident',
                       'allow_channelback': False, 'tags': ['sample', 'support', 'zendesk'],
